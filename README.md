...
PC0/PC1 are the dot product of standardized scores with the 10×2 PCA weight matrix. Note that Tao et al.'s R code uses the wrong parameters for this transformation (0.38 and -0.01).
